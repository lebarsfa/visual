...
// we can guarantee that we *never* have an ndarray on our hands that is not a
// genuine ndarray.  These functions needed to be changed to ensure that we do not
